...
public class ProductTwoPage extends BasePage {

	public ProductTwoPage() throws IOException {
		super();
	...
	By addProduct = By.cssSelector("#add-to-cart-sauce-labs-bike-light");
	By removeProduct = By.cssSelector("#remove-sauce-labs-bike-light");
