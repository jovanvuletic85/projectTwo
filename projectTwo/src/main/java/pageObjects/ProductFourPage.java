...
public class ProductFourPage extends BasePage {

	public ProductFourPage() throws IOException {
		super();
	...
	By addProduct = By.cssSelector("#add-to-cart-sauce-labs-fleece-jacket");
	By removeProduct = By.cssSelector("#remove-sauce-labs-fleece-jacket");
