...
public class ProductThreePage extends BasePage {
	...
	public ProductThreePage() throws IOException {
		super();
	...
	By addProduct = By.cssSelector("#add-to-cart-sauce-labs-bolt-t-shirt");
	By removeProduct = By.cssSelector("#remove-sauce-labs-bolt-t-shirt");
