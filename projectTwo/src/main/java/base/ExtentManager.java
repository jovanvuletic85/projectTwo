...
public class ExtentManager extends BasePage {
	...
	public static ExtentReports setupExtentReport(String testName) {
		...
		extentReport.setSystemInfo("Tester", "Jovan Vuletic");
	...
	public synchronized static ExtentTest createTest(String name, String descriprion) {
		ExtentTest test = extentReport.createTest(name, descriprion);
		extentTest.set(test);
		return getTest();
	}
